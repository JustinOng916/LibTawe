 ...
 *         the resource. I decided to limit the amount of data shown in this
 *         browser as users may get confused with what some of the random
 *         numbers or words mean.
 */

public class BrowserController2 {
    ...
    final String DATABASE_LOCATION = "Data/resourceDatabase2.txt"; //Location of database.
    ...
    private void refreshSearchResults() {
        ...
        try {
            ...
            while ((line = resourceBR.readLine()) != null) {
                ...
                rTitle = lineSplit[1];
                rYear = lineSplit[2];
                searchResults.getItems().add(rType + " - " + rTitle + " - " + rYear );
            }
        } catch (IOException e) {
    ...
    private void handleViewResourceEvent() throws Exception {
        ...
        if (selectedIndex < 0) {
            ...
            String selectedTitle = selectedSplit[1];
            ...
            try {
                ...
                String line = null; //The current line that the BufferedReader is on.
                line = resourceBR.readLine();
                resourceString = line;
                while (!resourceString.contains(selectedTitle)) {
                	line = resourceBR.readLine();
                    resourceString = line;
                }
            } catch(Exception e) {
